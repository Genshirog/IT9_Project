<div class="sticky top-0 w-52 h-screen bg-[#18303c] rounded-xl shadow-lg p-5 flex flex-col justify-between">
        <div class="w-full mt-6">
            <ul class="space-y-4">
                ...
                <li>
                    <p class="text-white font-semibold"><i class="fas fa-user mr-2"></i>Product Management</p>
                    <ul class="ml-4 mt-2 space-y-2">
                        <li><a href="{{ route('admin.user.add') }}" class="text-gray-300 hover:text-blue-400"><i class="fas fa-user-plus mr-2"></i>Add Product</a></li>
                        <li><a href="{{ route('admin.user.search') }}" class="text-gray-300 hover:text-blue-400"><i class="fas fa-search mr-2"></i>Check Product</a></li>
                    </ul>
                </li>
                <li>
                    <p class="text-white font-semibold"><i class="fas fa-user mr-2"></i>Site Management</p>
                    <ul class="ml-4 mt-2 space-y-2">
                        <li><a href="{{ route('admin.user.add') }}" class="text-gray-300 hover:text-blue-400"><i class="fas fa-user-plus mr-2"></i>Add Product</a></li>
                        <li><a href="{{ route('admin.user.search') }}" class="text-gray-300 hover:text-blue-400"><i class="fas fa-search mr-2"></i>Check Product</a></li>
                    </ul>
