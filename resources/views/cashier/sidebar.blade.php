        ...
        <div class="w-full mt-6">
            <ul class="space-y-4">
                ...
                <div class="text-center bg-[#1d3947] rounded-full mb-6">
                    <li><a href="{{ route('cashier.profile') }}" class="text-white hover:text-blue-500 uppercase"><i class="fas fa-cog mr-2"></i>{{ $user->username }}</a></li>
                </div>
                
                <li>
                    <p class="text-white font-semibold"><i class="fas fa-wrench mr-2"></i>Site Management</p>
                    <ul class="ml-4 mt-2 space-y-2">
                        <li><a href="{{ route('cashier.site.edit') }}" class="text-gray-300 hover:text-blue-400"><i class="fas fa-pencil-alt mr-2"></i>Orders</a></li>
                    </ul>
                </li>
            </ul>
        </div>
