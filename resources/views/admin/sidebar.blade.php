<div class="sticky top-5 w-52 h-screen bg-[#18303c] rounded-xl shadow-lg p-5 flex flex-col justify-between">
        <div class="w-full mt-6">
            <ul class="space-y-4">
                <div class="text-center p-3">
                    <h1 class="text-white font-bold text-2xl">BBQ LAGAO</h1>
                </div>
                <li><img src="{{ asset('images/wew.jpg') }}" alt="Profile" class="w-20 h-20 rounded-full mx-auto object-cover hover:opacity-80 transition" /></li>
                <div class="text-center bg-[#1d3947] rounded-full mb-6">
                    <li><a href="{{ route('admin.profile') }}" class="text-white hover:text-blue-500">Admin</a></li>
                </div>
                <li><a href="{{ route('admin.index') }}" class="text-white hover:text-blue-500"><i class="fas fa-tachometer-alt mr-2"></i>Dashboard</a></li>
                <li>
                    <p class="text-white font-semibold"><i class="fas fa-user mr-2"></i>User</p>
        ...
        <div class="text-center">
            <a href="#" class="text-white hover:text-blue-500">Logout<i class="fas fa-arrow-right ml-2"></i></a>
        </div>
    </div>